...
namespace RatingManagementSystem.Pages.Committee.Apps
{
    ...
    public class InformaticsAppsModel : PageModel
    {
        ...
        public InformaticsAppsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ApplicationData = await dbContext.Applications.Where(a => a.DrMajor == "Informatics" && a.CreatedAt > date && a.ApplicationStatus == "Verified").ToListAsync();
