...
namespace RatingManagementSystem.Pages.Committee.Apps
{
    ...
    public class ChemistryAppsModel : PageModel
    {
        ...
        public ChemistryAppsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ApplicationData = await dbContext.Applications.Where(a => a.DrMajor == "Chemistry" && a.CreatedAt > date && a.ApplicationStatus == "Verified").ToListAsync();
