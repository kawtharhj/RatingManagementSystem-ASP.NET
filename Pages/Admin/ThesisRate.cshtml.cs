...
namespace RatingManagementSystem.Pages.Admin
{
    ...
    public class ThesisRateModel : PageModel
    {
        ...
        public ThesisRateModel(RatingSystemDbContext con, UserManager<UserData> user)
        {
            db = con;
            userManager = user;
        }
        public async Task<IActionResult> OnGet(string filterValue)
        {
            ...
            {
                ApplicationData = db.Applications.Where(a => a.DrMajor == filterValue && a.ApplicationStatus == "In-Progress" && a.ThesisRateType == "ThesisRate").ToList();
            }
            else
            {

                ApplicationData = db.Applications.Where(a => a.ApplicationStatus == "In-Progress" && a.ThesisRateType == "ThesisRate").ToList();
            }
