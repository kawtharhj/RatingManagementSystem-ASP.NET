...
namespace RatingManagementSystem.Pages.Committee
{
    ...
    public class ElectronicModel : PageModel
    {
        ...
        public ElectronicModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        {
            UserInfoComit = await dbContext.Users.Where(a => a.DoctorMajor == "Electronic").ToListAsync();
        ...
        public async Task<IActionResult> OnPost(List<UserData> UserInfoComit)
        {
            ...
            foreach (var user in UserInfoComit)
            {
                ...
                if (user.isInCommittee == "true")
                {
                    ...
                    if (!userclaim.Any(c => c.Type == "Major" && c.Value == "Electronic"))
                    {
                        ...
                        await userManager.AddClaimAsync(userID, new Claim("Major", "Electronic"));
                    }
                    else if (userclaim.Any(c => c.Type == "Major" && c.Value == "Electronic") && isInComt == null)
                    {
                ...
                else
                {
                    ...
                    if (existingMember != null)
                    {
                        ...
                        await dbContext.SaveChangesAsync();
                        var claimRemove = new Claim("Major", "Electronic");
