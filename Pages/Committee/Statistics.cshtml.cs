...
namespace RatingManagementSystem.Pages.Committee
{
    ...
    public class StatisticsModel : PageModel
    {
        ...
        public StatisticsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        {
            UserInfoComit = await dbContext.Users.Where(a => a.DoctorMajor == "Statistics").ToListAsync();
        ...
        public async Task<IActionResult> OnPost(List<UserData> UserInfoComit)
        {
            ...
            foreach (var user in UserInfoComit)
            {
                ...
                if (user.isInCommittee == "true")
                {
                    ...
                    if (!userclaim.Any(c => c.Type == "Major" && c.Value == "Statistics"))
                    {
                        ...
                        await userManager.AddClaimAsync(userID, new Claim("Major", "Statistics"));
                    }
                    else if (userclaim.Any(c => c.Type == "Major" && c.Value == "Statistics") && isInComt == null)
                    {
                ...
                else
                {
                    ...
                    if (existingMember != null)
                    {
                        ...
                        await dbContext.SaveChangesAsync();
                        var claimRemove = new Claim("Major", "Statistics");
