...
namespace RatingManagementSystem.Pages.Committee.Apps
{
    ...
    public class ElectronicAppsModel : PageModel
    {
        ...
        public ElectronicAppsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ApplicationData = await dbContext.Applications.Where(a => a.DrMajor == "Electronic" && a.CreatedAt > date && a.ApplicationStatus == "Verified").ToListAsync();
