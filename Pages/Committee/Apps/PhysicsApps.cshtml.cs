...
namespace RatingManagementSystem.Pages.Committee.Apps
{
    ...
    public class PhysicsAppsModel : PageModel
    {
        ...
        public PhysicsAppsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ApplicationData = await dbContext.Applications.Where(a => a.DrMajor == "Physics" && a.CreatedAt > date && a.ApplicationStatus == "Verified").ToListAsync();
