...
namespace RatingManagementSystem.Pages.Committee.Apps
{
    ...
    public class GeologyAppsModel : PageModel
    {
        ...
        public GeologyAppsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ApplicationData = await dbContext.Applications.Where(a => a.DrMajor == "Geology" && a.CreatedAt > date && a.ApplicationStatus == "Verified").ToListAsync();
