...
namespace RatingManagementSystem.Pages.Committee.Apps
{
    ...
    public class BioChemistryAppsModel : PageModel
    {
        ...
        public BioChemistryAppsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        ApplicationData = await dbContext.Applications.Where(a => a.DrMajor == "BioChemistry" && a.CreatedAt >date && a.ApplicationStatus == "Verified").ToListAsync();
