...
namespace RatingManagementSystem.Pages.Committee.Apps
{
    ...
    public class StatisticsAppsModel : PageModel
    {
        ...
        public StatisticsAppsModel(UserManager<UserData> usr, RoleManager<IdentityRole> identrole, RatingSystemDbContext db)
        {
            userManager = usr;
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            ApplicationData = await dbContext.Applications.Where(a => a.DrMajor == "Statistics" && a.CreatedAt > date && a.ApplicationStatus == "Verified").ToListAsync();
